...
gui.tk.call("source", "C:\\Users\\catsl\\Documents\\Telemtry Dash\\Sun-Valley-ttk-theme-master\sun-valley.tcl")
...
if __name__ == "__main__":
    ...
    #Labels
    data1_ = tkinter.ttk.Label(text = "Data1:").place(x = 15, y= 100)
    data2_ = tkinter.ttk.Label(text = "Data2:").place(x = 15, y= 130)
    data3_ = tkinter.ttk.Label(text = "Data3:").place(x = 15, y= 160)
    data4_ = tkinter.ttk.Label(text = "Data4:").place(x = 15, y= 190)
    data5_ = tkinter.ttk.Label(text = "Data5:").place(x = 15, y= 220)

    baud   = tkinter.ttk.Label(text = "Baud").place(x = 100, y = 348)
    port   = tkinter.ttk.Label(text = "Port").place(x = 200, y = 348)

    #progress_bars
    progress_1 = tkinter.ttk.Progressbar(orient = HORIZONTAL, mode = 'determinate', length = 200, max = 255)
    progress_2 = tkinter.ttk.Progressbar(orient = HORIZONTAL, mode = 'determinate', length = 200, max = 255)
    progress_3 = tkinter.ttk.Progressbar(orient = HORIZONTAL, mode = 'determinate', length = 200, max = 255)
    progress_4 = tkinter.ttk.Progressbar(orient = HORIZONTAL, mode = 'determinate', length = 200, max = 255)
    progress_5 = tkinter.ttk.Progressbar(orient = HORIZONTAL, mode = 'determinate', length = 200, max = 255)
    ...
    #button
    button1 = tkinter.ttk.Button(text = "Send", command = send, width = 6).place(x = 15, y = 250)
    connect = tkinter.ttk.Button(text = "Connect", command = connect).place(x = 15, y = 360)
    disconnect = tkinter.ttk.Button(text = "Disconnect", command = disconnect).place(x =300, y = 360)
