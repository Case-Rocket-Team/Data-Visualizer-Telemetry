...
clients=[
{"broker":"127.0.0.1","port":1883,"name":"blank","sub_topic":"test1","pub_topic":"test1"},
{"broker":"127.0.0.1","port":1883,"name":"blank","sub_topic":"test2","pub_topic":"test2"}
]
...
try:
   while Run_Flag:
      ...
      for i in range(nclients):
         ...
         i+=1
      time.sleep(.5)#now print messages
